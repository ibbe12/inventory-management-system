...
```bash
git remote add encore encore://inventory-management-system-ahq2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/inventory-management-system-ahq2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/inventory-management-system-ahq2/settings/integrations/github)
